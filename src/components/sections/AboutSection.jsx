    ...
    <>
      <StyledAboutSection id="about">
        ...
        <AboutContent>
          ...
          <ol>
            <li>
              As part of the F5 Cloud services, I was a main contributor for the login flow, account management, subscription flows, services onboarding, and the billing enablement. 
            </li>
            <li>
